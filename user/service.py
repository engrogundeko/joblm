...
class UserService(AppwriteClient):
    ...
    def create_refresh_jwt(
        self, user_id: str, length: Optional[int] = None, expire: Optional[int] = None
    ) -> str:
        """Create token"""
    ...
    def login(self, email: str, password: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "refresh_token": self.create_refresh_jwt(user["$id"]),
        }
    ...
    def update_user_profile(
        ...
        try:
            ...
            return {"profile": updated_profile, "cv_upload": cv_upload}
        except Exception as e:
